...
Get-AzureADUser -ObjectId max.mustermann@foo.bar
Get-AzureADUser -SearchString "Max Mustermann"

# Explore deeper via object variable
$AADUser = Get-AzureADUser -ObjectId max.mustermann@foo.bar
...
# Or
Get-AzureADUser -ObjectId max.mustermann@foo.bar | Select-Object -ExpandProperty AssignedPlans
